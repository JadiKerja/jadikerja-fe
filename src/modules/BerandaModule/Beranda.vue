...
<template>
  <div class="h-screen flex flex-col px-7 pt-10 overflow-y-auto custom-scrollbar-hidden gap-6 pb-[6.5rem]">
    <div class="flex flex-col">
      <p class="text-[1.125rem] text-[#909090] tracking-[.01406rem]">Selamat datang,</p>
      <p class="text-[1.5rem] text-[#0A0E32] font-bold tracking-[.01875rem]">{{ user.client.fullName }}</p>
    </div>
    <div class="flex flex-col gap-4">
      ...
      <div class="w-full flex flex-row gap-4">
        ...
        :name="'PT Tokopedia'"
        :isKhusus="true"
        :tags="['Kerja di kantor', 'Penuh Waktu', 'Minimal Sarjana(S1)', 'apa aja', 'test']"
        class="w-full"
        />
        <BerandaCard 
        :id="'2'"
