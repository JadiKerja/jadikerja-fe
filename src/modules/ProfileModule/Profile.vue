...
<template>
  <div class="min-h-screen flex flex-col items-center w-full">
    <div class="bg-[rgb(214,39,39)] flex flex-col items-center relative w-full pt-6 pb-[2.5rem] gap-6 overflow-hidden">
      ...
      <TransparentCircle class="absolute top-[10rem] -left-[7rem] bg-[#E55A24B2] w-[10.66975rem] h-[10.66975rem]" />
      <TransparentCircle class="absolute top-[12rem] -left-[6rem] bg-[#E55A2466] w-[10.66975rem] h-[10.66975rem]" />
      
      <p class="text-[1.75rem] font-bold text-white tracking-[0.02188rem]">Profil Akun</p>

      <div class="flex relative items-center justify-center w-[5.9375rem] h-[6.1875rem] mt-4">
        <div
    ...
    <div class="flex flex-col px-7 pt-5 pb-[7rem] text-black font-semibold w-full gap-5">
