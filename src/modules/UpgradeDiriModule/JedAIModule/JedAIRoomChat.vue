...
<template>
  ...
  <div v-else class="h-screen flex flex-col items-center w-full">
      ...
      <div class="flex flex-row gap-5 w-full z-10">
        ...
        <div class="flex flex-row gap-5 items-center">
          ...
          <div class="flex flex-col">
            <p class="text-white text-[1.875rem] font-bold leading-[140%]">Jed AI</p>
          </div>
        </div>
        <div></div>
      </div>
    ...
    <div class="w-full z-50 flex flex-col items-center fixed bottom-0 max-w-[393px] px-5">
      ...
      <div class="w-full flex flex-row items-center gap-2">
        ...
        >
        <button class="bg-[#D62727] p-2 rounded-full" @click="handleSendMessage">
          <SentIcon />
        </button>
      </div>
    </div>
