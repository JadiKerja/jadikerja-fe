...
<template>
  <div
    class="rounded-[0.9375rem] bg-white flex-col p-[0.625rem] shadow-sm max-w-[10.125rem] flex gap-1"
  >
    ...
    <button
      class="py-1 px-4 min-w-[3.9rem] items-center justify-center bg-[#D62727] rounded-[0.3125rem] text-[0.5rem] font-semibold text-white w-fit"
    >
      Pilih
    </button>
  </div>
